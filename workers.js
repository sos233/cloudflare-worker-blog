...
const github_base = "sos233/cloudflare-worker-blog";

// 设置站点信息
var default_title	 = "DorianSOS Blog";					// 站点标题（显示在浏览器标题栏）
var default_intitle	 = "DorianSOS Blog";								// 站点名称（显示在首页）
var default_description  = "欢迎访问 DorianSOS 官方博客，本博客分享相关的技术以及记录一些日常。"; 	// 站点简介，有利于 SEO
var site_domain		 = "";								// 站点域名
var site_subtitle	 = "DorianSOS官方博客";							// 站点副标题
var site_favicon	 = "";				// 站点 Logo

// 博主信息
var owner_name = "DorianSOS";									// 博主名字
var owner_logo = ""	// 博主头像
var owner_desc = "";					// 博主简介

// 设置站点资源文件地址
var css_bootstrap	 = "https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css";		// Boostrap css 文件地址
var css_hljs_github   = "https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.9.0/build/styles/default.min.css";  	// Highlight js css 地址
var js_jquery		 = "https://cdn.jsdelivr.net/npm/jquery@3.6.4/dist/jquery.min.js";		// JQuery 地址
var js_bootstrap	= "https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js";		// Bootstrap 地址
...
var js_highlight_pack = "https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.9.0/build/languages/go.min.js;		// Highlight pack 地址
...
<a href="/">返回 ${default_intitle} 首页</a>
	...
	data += `</div>
			...
			<div class="row">
				<div class="col-sm-12">
				<p>Powered by CloudFlare Workers | <a href="https://github.com/sos233/cloudflare-worker-blog" target="_blank">Github</a></p>
				<p>&copy; 2024 ${default_intitle}</p>
				<br><br>
				</div>
			</div>
		</div>
